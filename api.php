<?php
/*
This is the BETA version of the  Web API.
It allows you to export data from  for use in Web applications.
By default the data is sent in XML format. To switch the output to JSON, you have to append mode=json to your queries.

**************
Authorization
**************
In order to prevent data from being served to unauthorized users, the  web api implements the same logins as  itself.
You have to append the parameters "username" and "pass" to every query you issue to the API.
These parameters need to contain username and Password of a valid  user.
...
Usage
******
The  API can be used by issuing a GET request with several parameters.
